...
function initCharacters() {
    var spongebob = new Character("Spongebob Squarepants", 150, 22, 5, "./Assets/images/spongebob.jpg");
    var patrick = new Character("Patrick Star", 220, 12, 11, "./Assets/images/patrick.jpg");
    var krabs = new Character("Mr. Krabs", 250, 10, 30, "../images/krabs.jpg");
    var myleg = new Character("My Leg", 150, 10, 5, "../images/myleg.jpg");
    var larry = new Character("Larry The Lobster", 60, 20, 40, "../images/larry.jpg");
}
